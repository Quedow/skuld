...
extension TaskQueryWhereSort on QueryBuilder<Task, Task, QWhere> {
  ...
  QueryBuilder<Task, Task, QAfterWhere> anyDueDateTime() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQueryWhere on QueryBuilder<Task, Task, QWhereClause> {
  ...
  QueryBuilder<Task, Task, QAfterWhereClause> dueDateTimeEqualTo(
  ...
  QueryBuilder<Task, Task, QAfterWhereClause> dueDateTimeNotEqualTo(
      DateTime dueDateTime) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Task, Task, QAfterWhereClause> dueDateTimeGreaterThan(
    DateTime dueDateTime, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterWhereClause> dueDateTimeLessThan(
    DateTime dueDateTime, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterWhereClause> dueDateTimeBetween(
